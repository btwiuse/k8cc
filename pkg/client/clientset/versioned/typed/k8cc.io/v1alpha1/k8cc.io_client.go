...
import (
	...
	"github.com/btwiuse/k8cc/pkg/client/clientset/versioned/scheme"
...
func NewForConfig(c *rest.Config) (*K8ccV1alpha1Client, error) {
	...
	return &K8ccV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new K8ccV1alpha1Client for the given config and
...
func New(c rest.Interface) *K8ccV1alpha1Client {
	return &K8ccV1alpha1Client{c}
}
